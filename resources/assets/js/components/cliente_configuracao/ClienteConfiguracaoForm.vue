    ...
    <div class="box">
      ...
      <div class="box-body">
          ...
          <div class="col-xs-6">
            <div class="form-group">
              ...
              <select
                ...
                v-model="id_topico"
                class="form-control"
                v-on:change="topico_alterado"
                :disabled="!topicos_enabled"
              >
                <option v-if="carregando_topico" :value="0">Carregando...</option>
                <option v-for="(item, index) in topicos" :key="index" :value="item.id">{{item.nome}}</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-6">
            <div class="form-group">
              <label>Palavra(s)</label>
              <input
                id="palavras"
                name="palavras"
                v-model="palavras_texto"
                type="text"
                class="form-control"
...
export default {
  ...
  methods: {
    ...
    topico_alterado() {
      ...
      if (!self.id_topico) return;

      self.palavras_texto = "Carregando...";
      self.palavras_texto_enabled = false;

      var url = `topicos/${self.id_topico}/palavras`;
    ...
    salvar() {
      ...
      var url = `topicos/${this.id_topico}/palavras`;
      ...
      obj_api.call(
        "topicos/" + this.id_topico + "/palavras",
        "PUT",
        data,
        function(retorno) {
          console.log("========================================");
