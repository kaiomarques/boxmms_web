...
Route::group([
        ...
        //v2
        Route::get("/edicoes", "EdicoesController@index");
        Route::get("/recortes", "RecortesController@index");
        Route::post("/materias", "MateriasController@index");
        Route::get("/materias", "MateriasController@index");
        
        Route::get("/clientes", "ClientesController@index");
        Route::get("/clientes/{clienteId}/canais/", "CanaisController@index");

        Route::get("/transcricoes/vinculos", "TranscricoesController@vinculos");

        Route::post("/programas", "Programas\ProgramasController@index");
        ...
        Route::get('/eventos_status', 'Eventos\EventoStatusController@listarTodosStatus');
        Route::post('/eventos_status_id', 'Eventos\EventoStatusController@getStatusById');        
        ...
        Route::get("topicos/{id}/palavras", "TopicosController@listaPalavras");
